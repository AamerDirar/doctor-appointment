                <footer class="footer">
                    <div class="w-100 clearfix">
                        <span class="text-center text-sm-left d-md-inline-block">Copyright © {{ date('Y') }}. All Rights Reserved.</span>
                        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Web app developing  <i class="fa fa-heart text-danger"></i> by <a href="" class="text-dark" target="_blank">Eng.Aamer Dirar</a></span>
                    </div>
                </footer>
            </div>
        </div>
        ...
        <script>window.jQuery || document.write('<script src="template/src/js/vendor/jquery-3.3.1.min.js"><\/script>')</script>
