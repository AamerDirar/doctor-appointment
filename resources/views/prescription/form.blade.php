    ...
    @if (count($bookings)>0)
    <!-- Modal -->
    <div class="modal fade" id="ShowPrescriptionModal{{$booking->user_id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="app">
                        ...
                        <div class="form-gorup">
                            ...
                            <textarea name="procedure_to_use_medicine" class="form-control"></textarea>
                        </div>
                        <div class="form-gorup">
